...
## Corpus Check
- 68 files · ~9,730,945 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1673 nodes · 2203 edges · 114 communities (100 shown, 14 thin omitted)
...
10. `交接文件 HANDOFF(給下一段對話無縫接手)` - 15 edges
...
### Community 5 - "main.js"
Cohesion: 0.06
Nodes (41): BASE_SPEED, FAN_PHI, HERO_BODY_SCALE, HERO_VISUAL_SCALE, HOMING_RANGE, MERGE_SPEED_K, MERGE_WIDTH_K, SOLO_TURN (+33 more)
...
Cohesion: 0.09
Nodes (45): supHash(), applyIntent(), warmSwordTint(), bakeHero(), bakeHeroF(), buildCracks(), buildPaper(), configureRender() (+37 more)

### Community 14 - "combat.js"
Cohesion: 0.13
Nodes (30): bladeLength(), buildStrokePasses(), canReturn(), cmdLife(), configureCombat(), detonateAnchor(), durCost(), extendCommand() (+22 more)
...
### Community 16 - "leadInLen"
Cohesion: 0.40
Nodes (5): leadInLen(), allowedLen(), down(), move(), pos()
...
Cohesion: 0.11
Nodes (18): G, stat, alignHud(), burst(), applyQuality(), computePlayTop(), configureViewport(), ctx (+10 more)
...
### Community 33 - "ui.js"
Cohesion: 0.07
Nodes (51): applyBattleMode(), bindHeroChoices(), bindPauseTabs(), bindSettingGroup(), bindSettingsSegments(), bindVolumeSettings(), CARD_CATEGORY_NAME, CARD_RANK_CN (+43 more)
...
### Community 36 - "$defs"
Cohesion: 0.17
Nodes (12): pattern, type, type, $defs, assetId, assetType, provenance, runtimeResource (+4 more)
...
Cohesion: 0.20
Nodes (18): advanceRealm(), bossTestFang(), bossTestLevel(), bossTestSwordCount(), bossTestWave60Preset(), doRespec(), dpsReset(), flash() (+10 more)
...
### Community 43 - "update"
Cohesion: 0.12
Nodes (20): spawnEnemy(), spawnNetherSpider(), updateBossShots(), waveDifficulty(), waveEnemyKind(), beginDeath(), buildBlots(), dmgTo() (+12 more)

### Community 44 - "properties"
Cohesion: 0.17
Nodes (12): format, type, type, $ref, generatedAt, humanEdited, modelProfileId, seed (+4 more)
...
## Knowledge Gaps
- **1064 isolated node(s):** `$schema`, `$id`, `title`, `type`, `additionalProperties` (+1059 more)
...
- **Why does `$defs` connect `$defs` to `enum`, `enum`, `properties`, `required`, `asset_manifest.schema.json`, `review`, `pivot`?**
...
- **Why does `properties` connect `properties` to `packageId`, `version`, `replacementAssetId`, `runtime`, `outputProfileId`, `review`, `sourceRecipeId`, `sourceFiles`, `required`, `runtimeResource`?**
