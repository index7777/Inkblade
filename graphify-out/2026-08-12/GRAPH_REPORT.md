...
## Corpus Check
- 102 files · ~11,102,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3077 nodes · 5112 edges · 145 communities (131 shown, 14 thin omitted)
...
### Community 5 - "main.js"
Cohesion: 0.04
Nodes (81): resetBootClock(), beginXuanmingWave(), spawnXuanmingBoss(), updateBossShots(), advanceRealm(), allowedLen(), applyIntent(), applyOpeningVars() (+73 more)
...
Cohesion: 0.09
Nodes (45): cmdLife(), leadInLen(), supHash(), warmSwordTint(), bakeHero(), bakeHeroF(), buildCracks(), buildPaper() (+37 more)
...
Cohesion: 0.13
Nodes (27): BOSS_PLAYER_Y_RATIO, bossDissolveMist(), bossMoveToSide(), bossOrbitRadius(), bossPhase(), bossSafeSide(), bossVisualLift(), completeXuanmingWave() (+19 more)
...
- **Why does `properties` connect `properties` to `packageId`, `version`, `assetType`, `outputProfileId`, `runtime`, `review`, `status`, `sourceRecipeId`, `sourceFiles`, `required`?**
