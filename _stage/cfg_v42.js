...
(function installInkBladeConfig(global) {
  ...
  const INSIGHTS = Object.freeze([
    ...
    insight({ id: 'truth_return_hidden', category: CATEGORY.TRUTH, rarity: RARITY.TRUTH, name: '歸藏無痕', rune: '藏', maxRank: 1, description: '增一趟折返,且回程每一趟傷害大增。', requires: ['inherit_return_hidden'], effects: [op('truth', 'activeTruth', 'truth_return_hidden'), op('set', 'mechanics.returnEnabled', true), op('add', 'mechanics.returnHits', 1), op('flag', 'flags.returnLeavesDryBrush', true), op('unlock', 'runUnlocks', 'returnDamageMultiplier:1.65')], fx: { trail: fx.DRY_BRUSH, hit: fx.WHITE_CUT } }),
